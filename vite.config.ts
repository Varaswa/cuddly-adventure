...
const SPA_ROUTES = [
  ...
  'herdebuch',
  'herdebuch/nwksoft',
  'herdebuch/registrierung',
  'herdebuch/zuchtprogramm',
  'herdebuch/lineare-beschreibung',
  'herdebuch/dna',
  'herdebuch/faser',
  'herdebuch/reglemente',
  'zucht-herdebuch',
  ...
  return {
    ...
    plugins: [
      ...
      isNativeBuild
        ...
        manifest: {
          id: `${PAGES_BASE}#ia-restructure-20260919`,
        ...
        workbox: {
          cacheId: 'nwks-ia-restructure-20260919',
          skipWaiting: true,
          clientsClaim: true,
